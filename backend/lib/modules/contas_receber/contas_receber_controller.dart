...
import 'contas_receber_service.dart';
import '../../core/helpers/json_response.dart';
import '../../core/helpers/query_helpers.dart';

class ContasReceberController {
  final ContasReceberService _service;

  ContasReceberController(this._service);
  ...
  Future<Response> darBaixa(Request request) async {
    ...
    return JsonResponse.ok(conta, message: 'Baixa realizada com sucesso');
  }
